...
class TaxonomiesSeeder extends Seeder
{
    ...
    public function setRestaurant(string $slug): void
    {
        $this->restaurant = Restaurant::where('domain', $slug)->first();
    ...
    private function createDish(
        ...
        return [
            'product' => [
                'name' => "{$name} {$this->restaurant->id}",
                'image_path' => "/uploads/{$image}",
                'description' => "Autogenerated description for {$name} product, restaurant: {$this->restaurant->id}.",
                'price' => 0.0,
                'type' => $type,
    ...
    {
        $this->setRestaurant(RestaurantSeeder::RESTAURANT_1);
        $this->loadDishes();
        $this->loadSidesAndDesserts();

        $this->setRestaurant(RestaurantSeeder::RESTAURANT_2);
        $this->loadDishes();
        $this->loadSidesAndDesserts();
    }
