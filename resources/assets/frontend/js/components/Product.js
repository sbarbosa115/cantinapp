                ...
                <div className="inner-mask">
                  <form action="#" method="post">
                    <div className="effect-ajax-cart">
                      ...
                      <button className="_btn add-to-cart" data-parent=".parent-fly"
                              onClick={(e) => this.addToOrder(e, this.state.product.id)} title="Add To Order">Add to
                        Order
                      </button>
                    </div>
                  </form>
            ...
            <div className="product-price">
                            <span className="price">
                                <span className="money"
                                      data-currency-usd={this.state.product.name}>{this.state.product.currency}</span>
                            </span>
            </div>
          </div>
        </div>
